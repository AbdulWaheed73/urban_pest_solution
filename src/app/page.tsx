...
export const metadata: Metadata = {
  title: "Urban Pest Solution — Professional Pest Control Services",
  description:
    "Integrated pest management for commercial and residential properties across Pakistan — backed by science, driven by technology, and committed to your safety. Termite treatment, fumigation, rodent control and more.",
  keywords: [
